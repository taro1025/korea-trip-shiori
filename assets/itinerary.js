window.TRIP_DATA = {
  ...
  accessSummary:
    "出発地が未確定でも、東京・関西・中部・福岡の空路と、福岡/下関/大阪から釜山へ入る船便を先に比較できます。",
  internationalRoutes: [
    {
      badge: "本命",
      title: "東京 → ソウル",
      summary: "羽田→金浦は市内アクセス重視、成田/羽田→仁川は便数・価格重視。",
      options: ["羽田 → 金浦（ソウル中心部寄り）", "羽田/成田 → 仁川（便数・価格を比較）"],
      note: "弘大拠点なら金浦着が楽。仁川着でもAREXで弘大入口駅へ直行できます。",
    },
    {
      badge: "西日本",
      title: "関西・中部 → ソウル",
      summary: "関西・中部は仁川に加えて金浦便も候補。ソウルだけなら直行便を優先。",
      options: ["関西 → 金浦/仁川", "中部 → 金浦/仁川", "出発時刻と帰国便の空港を合わせて選ぶ"],
      note: "関西発は便数が多く、LCCも含めて時間帯を選びやすいです。",
    },
    {
      badge: "九州",
      title: "福岡 → ソウル/釜山",
      summary: "九州発は移動時間が短く、釜山を絡めるなら福岡→釜山も候補。",
      options: ["福岡 → 仁川", "福岡 → 釜山（金海）", "釜山着の場合はKTXでソウル移動"],
      note: "今回の4泊5日でソウル中心なら、福岡からでも仁川直行が無難です。",
    },
    {
      badge: "船旅",
      title: "日本の港 → 釜山",
      summary: "飛行機以外なら、博多/下関/大阪から釜山へ入るフェリーも選べます。",
      options: ["博多港 → 釜山港", "下関港 → 釜山港", "大阪南港 → 釜山港"],
      note: "船便は天候や運航日に左右されるため、予約前に公式時刻表を確認してください。",
    },
  ],
  checkList: [
    "パスポート",
