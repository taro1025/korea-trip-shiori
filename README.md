...
宿はAirbnb「Home in Seoul」（ホストJeff）、麻浦区 서강로9길 30（30, Seogang-ro 9-gil, Mapo-gu, Seoul 04061・創前洞、6号線 光興倉駅すぐ）で、弘大入口駅を移動の基準にしています。チェックインは7/16 16:00、最終夜（7/19）にチェックアウトして仁川空港の仮眠室で前泊します。
...
- 宿の座標・住所を実際の宿（서강로9길 30・創前洞、6号線 光興倉駅すぐ）に更新し、Naver Map経路の起点を実地点に合わせて表示
