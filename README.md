...
宿はAirbnb「Home in Seoul」（ホストJeff）、麻浦区 서강로9길 30（30, Seogang-ro 9-gil, Mapo-gu, Seoul 04061）です。弘大入口駅まで徒歩約10分で、空港AREXとDMZ集合は弘大入口駅、市内の2号線移動は新村駅（徒歩約6分）を最短として、弘大入口駅を移動の基準にしています。チェックインは7/16 16:00、最終夜（7/19）にチェックアウトして仁川空港の仮眠室で前泊します。
...
- 7月20日（最終日）は未明起きを避け、前夜に宿をチェックアウトして仁川空港へ移動し、空港の仮眠室で前泊してから07:25仁川発とする構成
- 宿の座標・住所を実際の宿（서강로9길 30 / 37.5537435, 126.93186）に更新し、Naver Map経路の起点を実地点に合わせて表示（弘大入口駅を基準に、市内2号線は新村駅が最短）
...
- 7月20日の帰国便名、仁川空港ターミナル（前夜移動・仮眠室で前泊）
